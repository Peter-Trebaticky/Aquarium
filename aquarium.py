...
class Game(tk.Tk):
    ...
    def add_food(self):
        food_list = [Flake, Flake, Flake, Flake, Flake, Flake, Flake, Flake, Worm1, Worm2, Pellet]
    ...
    def game_over(self):
        ...
        self.canvas.create_text(self.bg.width()/2, 100, text="GAME OVER", font="arial 60", fill="orangered")
...
class Player(BaseSprite):
    ...
    def load_all_sprites(self):
        ...
        sprite_sheet["idle"]["left"] = self.load_sprites("player/left_idle.png", 5, 4)
        sprite_sheet["idle"]["right"] = self.load_sprites("player/right_idle.png", 5, 4)
        sprite_sheet["swim"]["left"] = self.load_sprites("player/left_swim.png", 3, 4)
        sprite_sheet["swim"]["right"] = self.load_sprites("player/right_swim.png", 3, 4)
